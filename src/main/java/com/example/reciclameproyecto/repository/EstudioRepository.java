...
import com.example.reciclameproyecto.entity.Estudio;
...
public interface EstudioRepository extends JpaRepository<Estudio, Long> {
       ...
       @Query("SELECT new com.example.reciclameproyecto.DTO.EstudioDTO(e.idEstudio, e.titulo, e.descripcion, e.anio, CAST(e.formato AS string), CAST(e.estado AS string), CAST(e.tipoAcceso AS string), e.fechaPublicacion) FROM Estudio e")
       List<EstudioDTO> findAllEstudioDTO();

       @Query("SELECT new com.example.reciclameproyecto.DTO.EstudioDTO(e.idEstudio, e.titulo, e.descripcion, e.anio, CAST(e.formato AS string), CAST(e.estado AS string), CAST(e.tipoAcceso AS string), e.fechaPublicacion) FROM Estudio e WHERE LOWER(e.titulo) LIKE LOWER(CONCAT('%', :keyword, '%'))")
