...
VALUES
(1, 1, 'Ana',     'Flores',  'Soto',   '72643574', 'ana.flores@reciclame.pe',      '999111111', '$2a$10$superadminhashdemo1', NULL, 'APROBADO', 'ACTIVO',    '2026-04-15 09:05:00', '2026-03-25 08:00:00', '2026-04-15 09:05:00', NULL),
(2, 2, 'Carlos',  'Ramirez', 'Lopez',  '73456789', 'carlos.ramirez@reciclame.pe',  '999222222', '$2a$10$adminhashdemo2',      NULL, 'APROBADO', 'ACTIVO',    '2026-04-15 08:40:00', '2026-03-26 09:30:00', '2026-04-15 08:40:00', NULL),
(3, 2, 'Lucia',   'Gomez',   'Diaz',   '74567890', 'lucia.gomez@reciclame.pe',     '999333333', '$2a$10$adminhashdemo3',      NULL, 'APROBADO', 'ACTIVO',    '2026-04-14 18:22:00', '2026-03-27 10:15:00', '2026-04-14 18:22:00', NULL),
(4, 3, 'Marco',   'Silva',   'Perez',  '75678901', 'marco.silva@alicorp.com',      '999444444', '$2a$10$sociohashdemo4',      NULL, 'APROBADO', 'ACTIVO',    '2026-04-15 07:55:00', '2026-03-29 11:00:00', '2026-04-15 07:55:00', NULL),
(5, 3, 'Paola',   'Flores',  'Mendez', '76789012', 'paola.flores@cicla.pe',        '999555555', '$2a$10$sociohashdemo5',      NULL, 'APROBADO', 'ACTIVO',    '2026-04-14 20:10:00', '2026-03-30 14:20:00', '2026-04-14 20:10:00', NULL),
(6, 3, 'Roberto', 'Bravo',   'Castro', '77890123', 'roberto.bravo@greenloop.pe',   '999666666', '$2a$10$sociohashdemo6',      NULL, 'APROBADO', 'BLOQUEADO', '2026-04-10 16:10:00', '2026-03-31 09:45:00', '2026-04-10 16:10:00', NULL),
(7, 4, 'Elena',   'Torres',  'Ruiz',   '78901234', 'elena.torres@upn.edu.pe',      '999777777', '$2a$10$visualhashdemo7',     NULL, 'APROBADO', 'ACTIVO',    '2026-04-15 09:11:00', '2026-04-01 08:50:00', '2026-04-15 09:11:00', NULL),
(8, 4, 'Diego',   'Mendoza', 'Salas',  '79012345', 'diego.mendoza@pucp.edu.pe',    '999888888', '$2a$10$visualhashdemo8',     NULL, 'APROBADO', 'ACTIVO',    '2026-04-13 17:00:00', '2026-04-02 17:10:00', '2026-04-13 17:00:00', NULL),
...
(10,'Valeria', 'Suarez',  'Gil',    '72345675', 'valeria.suarez@cicla.pe',   '988111115', '20604561234', 'SOCIO',        'APROBADO',  NULL, 3, 15, '2026-04-08 08:00:00', '2026-04-08 10:00:00');
